...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(searchDeviceAction) name:@"" object:nil];
...
//    [self.timer invalidate];
//    self.timer = nil;
//    [self.medicineInfoTimer invalidate];
//    self.medicineInfoTimer = nil;
    [self.timer setFireDate:[NSDate distantFuture]];
    [self.medicineInfoTimer setFireDate:[NSDate distantFuture]];
}
